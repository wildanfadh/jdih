<div class="content-wrapper">
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Tambah Lemari Arsip</h1>
        </div>
      </div>
    </div>
  </div>
            ...
            <form id="tambah_jenis" role="form">
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="macam" name="macam" placeholder="Macam" onkeyup="validateThis(this);" onchange="validateThis(this);">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="posisi" name="posisi" placeholder="Posisi Lemari" onkeyup="validateThis(this);" onchange="validateThis(this);">
                </div>
              </div>
