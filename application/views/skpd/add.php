            ...
            <form id="tambah_skpd" role="form">
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Satuan Kerja Perangkat Daerah (SKPD)" onkeyup="validateThis(this);" onchange="validateThis(this);">
                </div>
