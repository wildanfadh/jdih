<script>
    ...
    $(document).ready(function() {
        var tab_url = "<?php echo base_url("Pengajuan/penyusunan_ajax?pengajuan=a&paraf=$paraf"); ?>";
        <?php if ($pengajuan != "a") { ?>
            tab_url = "<?php echo base_url("Pengajuan/penyusunan_ajax?pengajuan=" . $pengajuan["id"] . "&paraf=$paraf"); ?>";
        <?php } ?>
        ...
        $("#daftar_select").change(function() {
            ...
            <?php if ($pengajuan != "a") { ?>
                $("#tab_penyusunan").DataTable().ajax.url("<?= base_url("Pengajuan/penyusunan_ajax?pengajuan=" . $pengajuan["id"] . "&paraf=$paraf"); ?>&status=" + status + "&opd=" + opd).load();
            <?php } else { ?>
                $("#tab_penyusunan").DataTable().ajax.url("<?= base_url("Pengajuan/penyusunan_ajax?pengajuan=a&paraf=$paraf&status="); ?>" + status + "&opd=" + opd).load();
            <?php } ?>
        });
