                                    ...
                                    <h3 class="card-title" style="float: right;">
                                        <strong>
                                            <?php if ($disposisi["is_penyusunan"]) {
                                                echo "Kasubbag. Perundang-Undangan";
                                            } elseif ($disposisi["is_bantuan"]) {
                                                echo "Kasubbag. Bantuan Hukum";
                                            } elseif ($disposisi["is_administrasi"]) {
                                                echo "Kasubbag. Dokumentasi dan Informasi";
                                            } ?>
                                        </strong>
                                    </h3>
                                </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-<?php echo (in_array($group, array(PERM_PERUNDANGAN, PERM_BANKUM, PERM_DOKUM))) ? "8" : "10"; ?>">
                                <?php if ($pengajuan == "a") {
                                    echo "&nbsp;";
                                } else { ?>
                                    <h3 class="card-title">
                            ...
                            <?php if (in_array($group, array(PERM_PERUNDANGAN, PERM_BANKUM, PERM_DOKUM))) { ?>
                                <div class="col-md-2 text-right">
                                    <select class="custom-select custom-select-sm" id="daftar_select">
                                        ...
                                        <option value="<?= PENYUSUNAN_SIAP ?>">Menunggu Siap Diambil</option>
                                    </select>
                                </div>
                            <?php } ?>
                            ...
                            <?php } else { ?>
                                <!-- <div class="col-md-2 text-right">
                                    <select class="custom-select custom-select-sm" id="daftar_select">
                                        ...
                                        <option value="<?= PENYUSUNAN_SIAP ?>">Siap Diambil</option>
                                        <option value="<?= PENYUSUNAN_PROSES ?>">Diproses</option>
                                        <?php if ($group != PERM_ASISTEN and $group != PERM_SEKDA and $group != PERM_WALIKOTA) {
                                            echo "<option value='" . PENYUSUNAN_KEMBALI . "'>Dikembalikan</option>";
                                        } ?>
                                    </select>
                                </div> -->
                            <?php } ?>
                        ...
                        <table id="tab_penyusunan" class="table table-bordered table-hover" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <?php } ?>
                                    <th style="max-width: 110px !important">Status</th>
...
<div class="modal fade" id="modal_view">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <?php if (in_array($group, array(PERM_BANKUM, PERM_PERUNDANGAN, PERM_DOKUM))) { ?>
