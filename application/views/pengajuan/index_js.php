<script>
    $(document).ready(function() {
        ...
        $("#tab_pengajuan").DataTable({
            ...
            "ajax": {
                "url": "<?php echo base_url("Pengajuan/index_ajax?"); ?>" + tabel_url,
                "type": "POST"
            },
            "deferRender": true,
            "columns": [{
        ...
        $("#opd_select").change(function() {
            var opd = $(this).val();
            opd = tabel_url + "&opd=" + opd;

            $("#tab_pengajuan").DataTable().ajax.url("<?= base_url("Pengajuan/index_ajax?"); ?>" + opd).load();
        });
        ...
        //     $("#tab_pengajuan").DataTable().ajax.url("<?= base_url("Pengajuan/index_ajax?"); ?>" + status).load();
        // });
        ...
        $(document).on("click", ".view-disposisi", function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $("#vidis_pengajuan").val(disposisi.id);
        ...
        // GENERATE LEMBAR DISPOSISI
        $(document).on("click", "#vidis_download", function() {
            var pengajuan = $("#vidis_pengajuan").val();
            window.open("<?= base_url("Export?pengajuan="); ?>" + pengajuan, '_blank');
        });
    });
</script>